...
export const metadata = generateSEOMetadata({
  title: "تماس با رهنورد - پشتیبانی ۲۴ ساعته و سوالات متداول",
  description:
    "راه‌های ارتباطی با تیم رهنورد، پشتیبانی ۲۴ ساعته، پاسخ به سوالات متداول درباره دریافت کمک اضطراری و ثبت نام داوطلبان",
  keywords: ["تماس با رهنورد", "پشتیبانی", "سوالات متداول", "راهنما", "کمک"],
});
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl" dir="rtl">
      ...
      <div className="prose prose-lg max-w-none space-y-6">
        ...
        <p className="text-lg leading-relaxed">
          ...
          سازماندهی شده‌اند، به کسانی که نیازمند یاری هستند متصل می‌کند.
        </p>
        ...
        <section className="mt-8">
          ...
          <div className="space-y-4 mr-4">
            ...
            <div>
              ...
              <p className="text-lg leading-relaxed">
                ما برای تایید صلاحیت‌ها، از پروتکل‌های ترکیبی (Human-in-the-loop
                AI) استفاده می‌کنیم تا با بهره‌گیری از دقت هوش مصنوعی و تجربه
                هوش انسانی، ضریب خطا را به حداقل برسانیم.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-lg leading-relaxed">
                تنها درخواست‌هایی در سامانه پذیرفته می‌شوند که فرآیند سخت‌گیرانه
                راستی‌آزمایی ما را پشت سر گذاشته باشند.
              </p>
            </div>
          </div>
        </section>
